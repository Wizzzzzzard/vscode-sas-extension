...
- Add Julia language support for PROC JULIA (syntax highlighting, notebook cells, code formatting preservation) ([#1878](https://github.com/sassoftware/vscode-sas-extension/pull/1878))
